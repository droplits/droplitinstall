<?php
// $Id: droplitinstall.profile,v 1.1.9 2011/01/02 03:11:46 droplits Exp $

/**
 * Implementation of hook_profile_details().
 */
function droplitinstall_profile_details() {
  return array(
    'name' => 'Droplit',
 ...
 */
function droplitinstall_profile_modules() {
  $modules = array(
     // Drupal core
    'block',
    // 'color',
 ...
 * Implementation of hook_profile_task_list().
  */
function droplitinstall_profile_task_list() {
  return array(
 ...
 */
function droplitinstall_profile_tasks(&$task, $url) {
  global $install_locale;
  _droplitinstall_modify_settings();
  _droplitinstall_modify_blocks();
  _droplitinstall_set_content_types();
  _droplitinstall_set_permissions();
  ...
  if ($task == 'profile') {
    $batch = array(
      ...
      'finished' => '_droplitinstall_profile_batch_finished',
  ...
  // profile directory.
    _droplitinstall_system_theme_data();
...
} // function droplitinstall_profile_tasks

/**
 * Modify the default settings of Drupal and contributed modules.
 */
function _droplitinstall_modify_settings() {
  global $theme_key;
 ...
 */
function _droplitinstall_modify_blocks() {
 ...
 */
function _droplitinstall_profile_batch_finished($success, $results) {
 ...
 */
function _droplitinstall_set_content_types() {
 ...
 * This workaround makes enabling themes in profiles/droplitinstall/themes possible.
 */
function _droplitinstall_system_theme_data() {
  global $profile;
  $profile = 'droplitinstall';
